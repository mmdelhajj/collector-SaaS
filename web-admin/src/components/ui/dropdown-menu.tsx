...
function DropdownMenuLabel({
  ...
  // Base UI's MenuPrimitive.GroupLabel requires a surrounding <Menu.Group>
  // and crashes if rendered standalone. The label here is a purely visual
  // header (user info, section title) — a plain div with the same data-slot
  // and styling is the right primitive and keeps the call sites unchanged.
  return (
    <div
